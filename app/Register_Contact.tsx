...
export default function Register_ContactScreen() {
  ...
  <Ionicons name="settings-outline" size={28} color="black" />
      ...
      <TextInput placeholder="Nombre" style={styles.input} placeholderTextColor="#999" />
      <TextInput placeholder="Número" style={styles.input} placeholderTextColor="#999" keyboardType="phone-pad" />
